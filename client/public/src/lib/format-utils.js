class FormatUtils {
   ...
   * @param {boolean} hoursMins
   */
  formatDate(datetime, abbreviated=false, hoursMins=false) {
    ...
    if (abbreviated) {
      ...
      formatted = `${this.padLeft(datetime.getHours())}:${this.padLeft(datetime.getMinutes())}`; // MM/DD@HH:MM
    } else {
